Page({
    ...
    initJoy: function (last_joy) {
        ...
        const arr = [];
        console.log('last_joy: ' + last_joy)
        if (last_joy.length > 0) { arr.push(last_joy) }
        else {
    ...
    showSentense: function (sentense) {
        ...
        var last_joy_key = 'lastJoy'
        wx.setStorageSync(last_joy_key, sentense)
